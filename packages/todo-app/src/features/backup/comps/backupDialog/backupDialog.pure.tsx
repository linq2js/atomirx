/**
 * BackupDialog presentation components.
 *
 * @description
 * Pure presentation components for BackupDialog.
...
/**
 * BackupDialog pure component props.
 */
export interface BackupDialogPureProps {
...
/**
 * BackupDialog pure presentation component.
 */
export function BackupDialogPure({
  open,
  activeTab,
  setActiveTab,
  isExporting,
