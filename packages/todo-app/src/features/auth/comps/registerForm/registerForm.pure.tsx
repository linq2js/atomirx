/**
 * RegisterForm presentation component.
 *
 * @description
 * Pure presentation component for RegisterForm.
...
/**
 * RegisterForm pure component props.
 */
export interface RegisterFormPureProps {
...
/**
 * RegisterForm pure presentation component.
 *
 * @example
 * ```tsx
 * <RegisterFormPure
 ...
 * ```
 */
export function RegisterFormPure({
  username,
  onUsernameChange,
  onSubmit,
  onSwitchToLogin,
