/**
 * PasskeyPrompt presentation component.
 *
 * @description
 * Pure presentation component for PasskeyPrompt.
...
/**
 * PasskeyPrompt pure presentation component.
 *
 * @example
 * ```tsx
 * {isAuthenticating && <PasskeyPromptPure />}
 * ```
 */
export function PasskeyPromptPure() {
  return (
...
/**
 * PasskeyError pure component props.
 */
export interface PasskeyErrorPureProps {
  /** Error code */
  code: string;
  /** Error message */
  message: string;
...
/**
 * PasskeyError pure presentation component.
 *
 * @businessRules
 ...
 * ```
 */
export function PasskeyErrorPure({
  code,
  message,
  onRetry,
  onCancel,
}: PasskeyErrorPureProps) {
