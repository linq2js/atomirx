 ...
 * - Input refocuses after submission for quick entry
 * - Value preserved on error for retry
 *
 * @edgeCases
 * - Rapid submissions: Loading state blocks until complete
 * - Network failure: Value kept, user can retry
 * - Leading/trailing whitespace: Trimmed before submit
 */
